...
INSERT INTO autopilot (
    ...
    status, execution_mode, issue_title_template, issue_body_template, project_id,
    created_by_type, created_by_id
) VALUES (
    $1, $2, sqlc.narg('description'), $3, $4,
    $5, $6, sqlc.narg('issue_title_template'), sqlc.narg('issue_body_template'), sqlc.narg('project_id'),
    $7, $8
) RETURNING *;
